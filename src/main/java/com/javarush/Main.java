...
public class Main {
    ...
    public Main() {
        ...
        properties.put(Environment.PASS, "26062017");
    ...
    private Customer createCustomer() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            address.setAddress("Berlagasse, 12");
            address.setPhone("999-888-777-66-55");
            address.setCity(city);
            address.setDistrict("Floridsdorf");
            addressDAO.save(address);

            Customer customer = new Customer();
            customer.setAddress(address);
            customer.setFirstName("Anna");
            customer.setLastName("Skripkina");
            customer.setActive(true);
            customer.setEmail("skripkina@gmail.com");
